 ...
 * @preserve Medkumo.jQuery DateTimePicker plugin v2.5.4
 * @homepage http://xdsoft.net/jqplugins/datetimepicker/
 * @author Chupurnov Valeriy (<chupurnov@gmail.com>)
 */
/*global DateFormatter, document,window,Medkumo.jQuery,setTimeout,clearTimeout,HighlightedDate,getCurrentValue*/
;(function (factory) {
	...
	$.fn.datetimepicker = function (opt, opt2) {
        ...
        // PhienNGO custom
        if (verticalPosition + $(datetimepickerElem).height() >= windowHeight) {
            verticalPosition = dateInputOffset.top - $(datetimepickerElem).outerHeight();
        }
        // PhienNGO end custom
...
/*!
 * Medkumo.jQuery Mousewheel 3.1.13
 *
 * Copyright Medkumo.jQuery Foundation and other contributors
